...
const FdCartReducer = (st = cart, action) => {
...
const FdUserReducer = (st = userState, action) => {
  switch (action.type) {
...
const FdCrntPrdtReducer = (state = crntPrdtState, action) => {
  switch (action.type) {
...
const FdToggleFav = (state = FavItems, action) => {
  switch (action.type) {
